...
/// 场景列表 - UI
/// </summary>
public class UISceneList : ModuleUIPanel, UIControl {
	...
	public UISceneList(VisualElement element, VisualElement canvas, VisualTreeAsset templateAsset, Action<SceneData> callback) : base(element) {
		this.callback = callback;
		ModuleUI.AddControl(this);
		Items = new UIScrollViewListV<UIItem, SceneData>(ScrollView, canvas, templateAsset,
	...
	public class UIItem : ModuleUIItem<SceneData> {
		...
		public UIItem(SceneData value, VisualElement element, UISceneList parent) : base(value, element) {
			this.parent = parent;
